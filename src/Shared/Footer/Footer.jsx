...
const Footer = () => {
    return (
        <div>
            <footer className="footer px-[200px] py-10 bg-neutral text-neutral-content">
                <aside>
                    <img className='w-[250px] lg:w-[200px] h-[80px] py-2 cursor-pointer' src="https://i.ibb.co/5Lc8cBw/smart-home.png" alt="" /> 
                    <p>Smart Build Ltd.<br />Providing Resonable Apartment Since 2002</p>
                </aside>
                <nav>
            ...
            <div className=" footer-center p-4 bg-black text-white">
                <aside>
                    <p>Copyright © 2023 - All right reserved by Smart Build</p>
                </aside>
            </div>
        </div>
    );
